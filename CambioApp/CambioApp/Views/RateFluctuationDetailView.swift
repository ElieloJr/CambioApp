...
//  CambioApp
//
//  Created by Usr_Prime on 20/10/23.
//
...
struct RateFluctuationDetailView_Previews: PreviewProvider {
    static var previews: some View {
        RateFluctuationDetailView(rateFluctuation: Fluctuation(symbol: "EUR", change: 0.0635, changePct: 0.0483, endRate: 131.651142), baseCurrency: "BRL")
    }
}
